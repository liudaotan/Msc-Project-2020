...
#$ -o ../Output/Q2_output_5cores.txt  #This is where your output and errors are logged.
...
spark-submit --driver-memory 40g --executor-memory 2g --master local[5] ../Code/Q2_code.py
