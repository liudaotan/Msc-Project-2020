...
#$ -o ../Output/Q1_outpput.txt  #This is where your output and errors are logged.
...
spark-submit --driver-memory 40g --executor-memory 2g --master local[10] ../Code/Q1_code.py